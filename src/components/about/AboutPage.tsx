...
export default function About({ aboutInfo }: Readonly<{ aboutInfo: AboutDocument }>) {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Section title="Our Vision & Mission" className="bg-gray-100">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <div className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 h-full flex flex-col">
            <h3 className="text-2xl font-bold text-primary mb-4">Our Vision</h3>
            <p className="text-gray-700 flex-grow">{aboutInfo?.vision}</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 h-full flex flex-col">
            <h3 className="text-2xl font-bold text-primary mb-4">Our Mission</h3>
            <p className="text-gray-700 flex-grow">{aboutInfo?.mission}</p>
          </div>
        </div>
      </Section>
